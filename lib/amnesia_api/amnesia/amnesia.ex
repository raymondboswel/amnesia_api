defmodule AmnesiaApi.Amnesia do
  ...
  @doc """
  Returns the list of chapter_questions.

  ## Examples

      iex> list_chapter_questions()
      [%ChapterQuestion{}, ...]

  """
  def list_chapter_questions do
    Repo.all(ChapterQuestion)
  end

  @doc """
  Gets a single chapter_question.

  Raises `Ecto.NoResultsError` if the Chapter question does not exist.

  ## Examples

      iex> get_chapter_question!(123)
      %ChapterQuestion{}

      iex> get_chapter_question!(456)
      ** (Ecto.NoResultsError)

  """
  def get_chapter_question!(id), do: Repo.get!(ChapterQuestion, id)

  @doc """
  Creates a chapter_question.

  ## Examples

      iex> create_chapter_question(%{field: value})
      {:ok, %ChapterQuestion{}}

      iex> create_chapter_question(%{field: bad_value})
      {:error, %Ecto.Changeset{}}

  """
  def create_chapter_question(attrs \\ %{}) do
    %ChapterQuestion{}
    |> ChapterQuestion.changeset(attrs)
    |> Repo.insert()
  end

  @doc """
  Updates a chapter_question.

  ## Examples

      iex> update_chapter_question(chapter_question, %{field: new_value})
      {:ok, %ChapterQuestion{}}

      iex> update_chapter_question(chapter_question, %{field: bad_value})
      {:error, %Ecto.Changeset{}}

  """
  def update_chapter_question(%ChapterQuestion{} = chapter_question, attrs) do
    chapter_question
    |> ChapterQuestion.changeset(attrs)
    |> Repo.update()
  end
  ...
  @doc """
  Deletes a ChapterQuestion.

  ## Examples

      iex> delete_chapter_question(chapter_question)
      {:ok, %ChapterQuestion{}}
  ...
  """
  def delete_chapter_question(%ChapterQuestion{} = chapter_question) do
    Repo.delete(chapter_question)
  end

  @doc """
  Returns an `%Ecto.Changeset{}` for tracking chapter_question changes.

  ## Examples

      iex> change_chapter_question(chapter_question)
      %Ecto.Changeset{source: %ChapterQuestion{}}

  """
  def change_chapter_question(%ChapterQuestion{} = chapter_question) do
    ChapterQuestion.changeset(chapter_question, %{})
  end
